 ...
 * - IDs v�lidos: 1..LEDS_NUMBER (0 no es v�lido)
 *
 * Requiere de board.h:
 *   - LEDS_NUMBER           : n�mero de leds disponibles (0 si ninguno)
 *   - LEDS_LIST             : lista de pines GPIO (ej: {LED1_GPIO, LED2_GPIO, ...})
 *   - LEDS_ACTIVE_STATE     : 1 si el LED est� encendido con nivel alto, 0 si con nivel bajo
 *
 ...
 * el n�mero de LEDs disponibles en la plataforma.
 */
...
/**
 * @brief Obtiene el estado l�gico de un LED.
 *
 * @param id         Identificador del LED (1..N).
...
/** Devuelve de nuevo el n�mero total de LEDs disponibles */
