...
//Monitores
#define MONITORS_NUMBER 4

#define MONITOR_1          NRF_GPIO_PIN_MAP(0,28)
#define MONITOR_2          NRF_GPIO_PIN_MAP(0,29)
#define MONITOR_3          NRF_GPIO_PIN_MAP(0,30)
#define MONITOR_4          NRF_GPIO_PIN_MAP(0,31)

/* Igual lógica que los LEDs */
#define MONITORS_ACTIVE_STATE  LEDS_ACTIVE_STATE

#define MONITORS_LIST { MONITOR_1, MONITOR_2, MONITOR_3, MONITOR_4 }
